...
const PokedexName = () => {
  ...
  return (
    <div className="PokedexName">
      {hasError ? (
        <div className="PokedexName__error">
          <h2 className='pn__error-h2'>The pokemon {name} doesn't exist</h2>
          <button onClick={handleSubmit}>Regresar</button>
          <img src="https://i.gifer.com/ZAbj.gif" alt="" />
        </div>
      ) : (
        <>
          <div className="pokename_decoration-t">
            <img src="../assets/bgt.png" alt="" />
          </div>
          <img
